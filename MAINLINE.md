...
- [`research/synthesis/LLM_WIKI_CURRENT_KNOWLEDGE_SYSTEM.md`](research/synthesis/LLM_WIKI_CURRENT_KNOWLEDGE_SYSTEM.md): LLM Wiki / Current Knowledge subsystem definition.

The four mechanisms remain orthogonal and do not replace one another:

1. Stigmergy — environment-mediated coordination.
2. LLM Wiki — current knowledge compilation.
3. Software 3.0 — versioned natural-language protocol assets.
4. Controlled AutoResearch — bounded empirical iteration and selection.

Files and the persistent artifact world are their shared continuity substrate.

## Authority Boundary

- `state/CURRENT.md` is the only canonical source for what the Reform Lab is doing now and what action is authorized next.
