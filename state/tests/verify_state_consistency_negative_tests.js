...
runFixtureTest('10_multiple_next_action_blockquotes', false, (dir) => {
  ...
  let content = fs.readFileSync(p, 'utf8');
  const targetStr = '> Prepare a bounded Modularity & Replaceability Doctrine proposal for outside review. Define Artifact-first persistence and environment-mediated coordination as stable kernel principles, and define the five current capabilities as replaceable providers. Do not implement providers or modify CR-S0.';
