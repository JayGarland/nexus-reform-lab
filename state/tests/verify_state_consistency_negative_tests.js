...
runFixtureTest('10_multiple_next_action_blockquotes', false, (dir) => {
  ...
  let content = fs.readFileSync(p, 'utf8');
  const targetStr = '> Submit the Knowledge E3 closure and Stigmergy Carrier & Artifact Taxonomy for outside review. Do not run another Probe, select a Knowledge Provider, or connect official Nexus.';
