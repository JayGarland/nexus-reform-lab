...
runFixtureTest('10_multiple_next_action_blockquotes', false, (dir) => {
  ...
  let content = fs.readFileSync(p, 'utf8');
  const targetStr = '> Submit the Seeded Instance Continuity concept clarification for outside review. Do not implement Runtime, select a carrier, run a Probe, or connect official Nexus.';
