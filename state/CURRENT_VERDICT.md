...
| **State Consistency** | `CONFIRMED — fail-closed verifier and negative-fixture proof externally accepted.` | [`STATE_MODEL.md`](STATE_MODEL.md) + [`state/logs/state_consistency_negative_tests.log`](logs/state_consistency_negative_tests.log) | Box-outside acceptance of Foundation 0.3.2f (12/12 negative, 1/1 positive) |
| **Repository-wide Persistent Artifact World** | `PARTIAL — Level 1 Re-entry Scaffold confirmed; Level 2 structural recovery path present but empirical fresh-instance cold-start remains untested.` | [`research/audit/world-audit/WORLDHOOD_VERDICT.md`](../research/audit/world-audit/WORLDHOOD_VERDICT.md) | Read-only World audit PARTIAL PASS (Foundation 0.4) |
...
| **Cold-Start Recoverability** | `AUTHORIZED — NOT YET EXECUTED` | [`COLD_START_RECOVERY_TEST.md`](../research/audit/COLD_START_RECOVERY_TEST.md) | Fresh-instance cold-start test authorized for a NEW instance; must be run read-only |
