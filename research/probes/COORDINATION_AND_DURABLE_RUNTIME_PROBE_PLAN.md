...
> **Basis**: [`CONTRACT_TO_PROBE_MATRIX.md`](../../archive/research/probes/CONTRACT_TO_PROBE_MATRIX.md) (`CONFIRMED FOR PROBE-PLANNING SCOPE`), [`E3_PROBE_QUEUE.md`](../../archive/research/plans/E3_PROBE_QUEUE.md), [`E3_EXECUTION_PROTOCOL.md`](../../archive/research/plans/E3_EXECUTION_PROTOCOL.md), [`E3_ENVIRONMENT_ISOLATION.md`](../../archive/research/plans/E3_ENVIRONMENT_ISOLATION.md), [`BOUNDED_RUNTIME_EXECUTION_AND_RECOVERY_MINIMUM_CONTRACT.md`](../../archive/research/contracts/BOUNDED_RUNTIME_EXECUTION_AND_RECOVERY_MINIMUM_CONTRACT.md) (`CONFIRMED FOR SEMANTIC CONTRACT SCOPE`), [`WORK_ITEM_MINIMUM_CONTRACT.md`](../../archive/research/contracts/WORK_ITEM_MINIMUM_CONTRACT.md) (`CONFIRMED FOR SEMANTIC CONTRACT SCOPE`).
