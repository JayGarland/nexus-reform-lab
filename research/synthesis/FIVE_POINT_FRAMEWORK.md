...
- [`STIGMERGY_CARRIER_AND_ARTIFACT_TAXONOMY.md`](../../archive/research/synthesis/STIGMERGY_CARRIER_AND_ARTIFACT_TAXONOMY.md) — `CONCEPT CLARIFICATION — CONFIRMED FOR CONCEPTUAL SCOPE` (archived as pre-probe hypothesis). Not immutable permanent architecture; may evolve through a formal proposal. Clarifies Stigmergy (environment-mediated coordination concept/capability boundary), carriers, artifact types, stigmergic signals, optional extensions, and the Nexus boundary. Does not amend this framework.
